// code360 (link): https://www.naukri.com/code360/problems/merge-sort_920442
// M2: use indexes


// M1 : create two aray & copy values n new array
#include <iostream>
using namespace std;
...
int main()
{
	int arr[20] = {3,8,4,78,14,10,85,36,42,15,20,35,4,1};
	int size = 20;
